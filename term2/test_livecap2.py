...
def capture_live_packets():
    global matchcount,nxtseq,ack,size,request_uri,response_uri,delay,num_lost,avg_delay,old_ack
    ...
    schedule.every(1).minutes.do(testing)
...
def testing():
    ...
    # เขียนไฟล์ Excel
    wb.save("excel/result" + count + ".xls")
    count += 1
