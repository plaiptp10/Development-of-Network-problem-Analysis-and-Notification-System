...
# capture packet from file filter http protocol
...
# if packetcount % 2 == 0:
#     for i in range(0, len(nxtseq)-1, 2):
#         if nxtseq[i] == ack[i+1]:
#             matchcount += 1
#         else:
#             num_lost += 1
# else:
# for i in range(0, len(nxtseq)-1):
#     if nxtseq[i] == ack[i+1] :
#         matchcount += 1
    # else:
    #     num_lost += 1
...
print("HTTP match packet : " + str(matchcount))
print("Average Size : " + str(avg_size_total))
print("Average Lost Packet : " + str(avg_lost))
